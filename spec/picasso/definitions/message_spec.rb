...
describe Picasso::SDoc::Definitions::Message do
  ...
  describe 'constants' do
    context 'ERROR_LEVEL' do
      subject { Picasso::SDoc::Definitions::Message::ERROR_LEVEL }

      it { should == 'error' }
    end

    context 'INFO_LEVEL' do
      subject { Picasso::SDoc::Definitions::Message::INFO_LEVEL }

      it { should == 'info' }
    end

    context 'WARNING_LEVEL' do
      subject { Picasso::SDoc::Definitions::Message::WARNING_LEVEL }
